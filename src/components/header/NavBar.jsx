        ...
        <div className ={`capitalize ${ user && "flex items-center justify-between pr-[5rem]"}`}>
            ...
            { /* user icon, name & signout btn*/
                user  && <div className={`flex items-center gap-x-[1rem] relative z-[2]`}> 
                    ...
                    className={ ` ${!user ? "hidden" : "bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500  text-[1rem] capitalize font-semibold rounded-[8px] text-white px-[12px] py-[3px] "}`}>
                        GPT search
                    </button>
