...
const handleHeaderClasses = ( user, gpt, deviceType ) => {
    ...
    if(!gpt){
        ...
        if(deviceType == "mobile"){
            headerCss += baseBeforeCss + `before:h-full before:bg-[url('https://image.tmdb.org/t/p/w500/l10eghFN1nQmWwMSt91MlLvZZFA.jpg')] `
        }
